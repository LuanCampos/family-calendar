...
export const SettingsPanel = ({ currentMonthLabel, onDeleteMonth, isOpen: externalIsOpen, onClose }: SettingsPanelProps) => {
  ...
  if (activeSection === 'profile') {
    return (
      <Dialog open={externalIsOpen ?? open} onOpenChange={handleOpenChange}>
